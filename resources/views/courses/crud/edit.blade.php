        ...
        <div class="form-row">
            <div class="form-group col-md-12 d-flex flex-row">
                ...
                <div class="col-md-6 d-flex flex-column card m-auto">
                    <img class="card-img-top m-auto" src="{{ asset('courses/img/' . $course->course_img) }}" id="preview"
                        style="display: block;" alt="Course Image Preview" height="320">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text font-weight-bold" id="inputGroupFileAddon01">Upload Course
                                Image</span>
                        </div>
            ...
            <div class="col-md-12 d-flex flex-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="number" class="form-control" id="lecture_no" name="lecture_no"
                        value="{{ $course->lecture_no }}" required>
                </div>
                <div class="form-group col-md-3">
                    ...
                    <input type="number" class="form-control" id="hours_no" name="hours_no"
                        value="{{ $course->hours_no }}" required>
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="col-md-12 d-flex flex-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="status" name="status" required>
                        ...
                        <option value="disactive" {{ $course->status == 'disactive' ? 'selected' : '' }}>Disactive
                        </option>
