            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('courses.destroy', $course->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger">Delete</button>
                                        ...
                                        <a href="{{ route('courses.edit', $course->id) }}"><i class="fa-regular fa-pen-to-square fa-lg mx-2"
                                                style="color: #74C0FC;"></i></a>
                                                <a class="text-danger tx-20 delete-course" href="#" data-toggle="modal" data-target="#deleteCourseModal{{ $course->id }}">
