...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            {{-- <li class="side-item side-item-category">courses categories</li> --}}
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">courses categories</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">all courses categories</a>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">create new category</a></li></li>
                </ul>
            {{-- </li> --}}
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">instructors</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">requests</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
