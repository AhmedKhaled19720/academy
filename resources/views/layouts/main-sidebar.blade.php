...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}">
            <img src="{{ URL::asset('assets/img/brand/logo.jpeg') }}" class="main-logo" alt="logo">
        </a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'index')) }}">
            <img src="{{ URL::asset('assets/img/brand/logo.jpeg') }}" class="main-logo dark-theme" alt="logo">
        </a>
        ...
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'index')) }}">
            <img src="{{ URL::asset('assets/img/brand/logo.jpeg') }}" class="logo-icon dark-theme" alt="logo">
        </a>
    </div>

    <div class="main-sidemenu app-sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}">
                    <i class="side-menu__icon fa fa-home"></i><span class="side-menu__label">home</span>
                </a>
            </li>

            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    <i class="side-menu__icon fa fa-list-alt"></i><span class="side-menu__label">courses
                        categories</span>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    <i class="side-menu__icon fa-solid fa-book-open"></i><span class="side-menu__label">courses</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    <i class="side-menu__icon fa-solid fa-chalkboard-user"></i>
                    <span class="side-menu__label">Enroll Course</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                    <i class="side-menu__icon fa-solid fa-code-pull-request"></i>
                    <span class="side-menu__label">requests</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'allinstructors')) }}">instructors
                            requests</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('home-setting') }}">home setting </a></li>
                </ul>
            </li>
